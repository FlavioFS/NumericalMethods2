...
int main(int argc, char *argv[])
{
    ...
    if ( fileRead(argv[1]) )
    {
        ...
        double result = Derivative::centRichardson(f, value, spacing, true);
        
        // TODO put this on the view logic
        cout << endl << "Derivative by Central method Difference with Richardson Extrapolation: " << result << endl;
    }
